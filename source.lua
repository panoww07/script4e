...
local Scripts_Section_Button = Instance.new("TextButton")
...
local NamelessAdmin_Button = Instance.new("TextButton")
local InfYield_Button = Instance.new("TextButton")
local ZacksHub_Button = Instance.new("TextButton")
local CopyInvite_Button = Instance.new("TextButton")
local kittyHub_Button = Instance.new("TextButton")
...
local Scripts_Section = Instance.new("ScrollingFrame")
local Scripts_Label = Instance.new("TextLabel")
...
TitleBarLabel.Text = "			edit-script ot kozunaka"
TitleBarLabel.TextColor3 = Color3.fromRGB(204, 2, 2)
...
Scripts_Section_Button.Position = UDim2.new(0, 0, 0, 265)
Scripts_Section_Button.Size = UDim2.new(0, 105, 0, 30)
Scripts_Section_Button.Font = Enum.Font.Oswald
Scripts_Section_Button.Text = "Scripts"
Scripts_Section_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
Scripts_Section_Button.TextScaled = true
Scripts_Section_Button.TextSize = 14.000
Scripts_Section_Button.TextWrapped = true
...
Announce_Label.TextColor3 = Color3.fromRGB(0, 0, 0)
...
Explode_Button.Position = UDim2.new(0, 25, 0, 175)
...
Rejoin_Button.Position = UDim2.new(0, 25, 0, 225)
...
NoRainbowUI_Button.Position = UDim2.new(0, 25, 0, 275)
...
CMDX_Button.Position = UDim2.new(0, 25, 0, 75)
...
local orca_Button = Instance.new("TextButton")
...
orca_Button.Position = UDim2.new(0, 25, 0, 125)
orca_Button.Size = UDim2.new(0, 150, 0, 30)
orca_Button.Font = Enum.Font.Oswald
orca_Button.Text = "Orca Script"
orca_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
orca_Button.TextScaled = true
orca_Button.TextSize = 14.000
orca_Button.TextWrapped = true

orca_Button.MouseButton1Click:Connect(function()
...
NamelessAdmin_Button.Position = UDim2.new(0, 210, 0, 75)
NamelessAdmin_Button.Size = UDim2.new(0, 150, 0, 30)
NamelessAdmin_Button.Font = Enum.Font.Oswald
NamelessAdmin_Button.Text = "Nameless Admin"
NamelessAdmin_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
NamelessAdmin_Button.TextScaled = true
NamelessAdmin_Button.TextSize = 14.000
NamelessAdmin_Button.TextWrapped = true
...
InfYield_Button.Position = UDim2.new(0, 210, 0, 25)
...
ZacksHub_Button.Position = UDim2.new(0, 25, 0, 25)
ZacksHub_Button.Size = UDim2.new(0, 150, 0, 30)
ZacksHub_Button.Font = Enum.Font.Oswald
ZacksHub_Button.Text = "Zacks Easy Hub"
ZacksHub_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
ZacksHub_Button.TextScaled = true
ZacksHub_Button.TextSize = 14.000
ZacksHub_Button.TextWrapped = true
...
FreeEmotes_Button.Position = UDim2.new(0, 210, 0, 175)
...
CopyInvite_Button.Position = UDim2.new(0, 210, 0, 225)
...
Scripts_Section.Name = "Scripts_Section"
Scripts_Section.Parent = Background
Scripts_Section.Active = true
Scripts_Section.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Scripts_Section.BackgroundTransparency = 1.000
Scripts_Section.BorderColor3 = Color3.fromRGB(0, 0, 0)
Scripts_Section.BorderSizePixel = 0
Scripts_Section.Position = UDim2.new(0, 105, 0, 30)
Scripts_Section.Size = UDim2.new(0, 395, 0, 320)
Scripts_Section.Visible = false
Scripts_Section.CanvasSize = UDim2.new(0, 0, 0.8, 0)
Scripts_Section.ScrollBarThickness = 5
...
kittyHub_Button.Position = UDim2.new(0, 210, 0, 125)
kittyHub_Button.Size = UDim2.new(0, 150, 0, 30)
kittyHub_Button.Font = Enum.Font.Oswald
kittyHub_Button.Text = "Kitty Hub"
kittyHub_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
kittyHub_Button.TextScaled = true
kittyHub_Button.TextSize = 14.000
kittyHub_Button.TextWrapped = true

kittyHub_Button.MouseButton1Click:Connect(function()
...
Scripts_Section_Button.MouseButton1Click:Connect(function()
	ChangeSection(Scripts_Section_Button)
end)
...
ZacksHub_Button.MouseButton1Click:Connect(function()
...
NamelessAdmin_Button.MouseButton1Click:Connect(function()
